...
uint16_t I2SCamera::blocksReceived = 0;
uint16_t I2SCamera::framesReceived = 0;
uint16_t I2SCamera::xres = 160;
uint16_t I2SCamera::yres = 120;
uint16_t I2SCamera::startBlock = 0;
uint16_t I2SCamera::endBlock = 0;
uint8_t I2SCamera::blockSlice = 0;
...
uint16_t I2SCamera::dmaBufferCount = 0;
uint16_t I2SCamera::dmaBufferActive = 0;
DMABuffer** I2SCamera::dmaBuffer = 0;
unsigned char* I2SCamera::frame = 0;
uint32_t I2SCamera::framePointer = 0;
uint32_t I2SCamera::frameBytes = 0;
...
void I2SCamera::deinitVSync() { esp_intr_disable(vSyncInterruptHandle); }
...
void I2SCamera::dmaBufferDeinit() {
  ...
  dmaBuffer = 0;
  dmaBufferCount = 0;
  DEBUG_PRINTLN("dma buffer memory freed\n");  
}
